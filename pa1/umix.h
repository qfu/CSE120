 ...
 *	For a more complex example, consider Fork (), which is used to
 *	create a process. It returns -1 if process creation failed, else
 *	it returns the process ID of the child to the parent, and 0 to the
 *	child (recall that Fork returns in both the parent and child processes).
 */
